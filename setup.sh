...
mkdir -p HyperWorldFoodBot
cd HyperWorldFoodBot
...
npm install telegraf telegraf-session-local axios markdown-escape dotenv

# Create index.js with the bot script
cat << 'EOF' > index.js
...
echo "1. Edit the .env file and replace 'your-telegram-bot-token-here' with your Telegram Bot Token from @BotFather."
echo "2. Run the bot with: cd HyperWorldFoodBot && node index.js"
echo "3. Open Telegram, find your bot, and send your Hyperbolic API key to unlock features."
echo "Or use my bot: @HyperWorldFood_bot"
